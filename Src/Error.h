...
enum ErrorType{
    ...
    ERROR_INVALID_TYPE_CHECK = 122,
    ERROR_INVALID_RELATION = 123,
    ERROR_INVALID_EXPRESSION = 124,
    ERROR_INVALID_ASSIGNMENT = 125,
    ERROR_INVALID_ARRAY_INDEX = 126,
    ERROR_INVALID_PROCEDURE = 127,
    ERROR_INVALID_VARIABLE = 128,
